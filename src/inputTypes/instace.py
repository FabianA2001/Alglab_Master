...
class Instance(BaseModel):
    ...
    def instance_to_one_shift_type(self):
        ...
        for shift_uid, shift_type in self.shift_types.items():
            shift_length = (
                shift_length + shift_balance_dict[shift_uid] * shift_type.length
            )
