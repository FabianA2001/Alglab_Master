...
def process_file_immediate(json_file, x, constraint_number, key):
    ...
    solution = solver.solve_with_early_stop_immediate(log_search_progress=False, max_time_in_seconds=30*60, constraint_set = constraint_number).model_copy(deep=True)
